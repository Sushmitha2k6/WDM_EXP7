...
### Output:
<img width="855" height="876" alt="image" src="https://github.com/user-attachments/assets/83f54e9b-1daa-49a7-a08d-506833fe6e26" />

### Result:
Hence, implemented Link Analysis using HITS Algorithm in Python.
